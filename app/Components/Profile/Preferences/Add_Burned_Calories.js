...
export default function Add_Burned_Calories() {
  const [weightUnit, setWeightUnit] = useState("kg");
  const [items, setItems] = useState([]); // raw docs
  const [loading, setLoading] = useState(true);

  // Switch state mirrors Firestore users/$uid.AddExerciseCalories ("yes" | "no")
  ...
  // Toggle and save to Firestore: users/$uid.AddExerciseCalories -> "yes"/"no"
    ...
    <>
      <View style={{ width: "100%", height: "100%" }}>
        ...
        >
          ...
          >
            Add burned calories to your daily goal
          </Text>
