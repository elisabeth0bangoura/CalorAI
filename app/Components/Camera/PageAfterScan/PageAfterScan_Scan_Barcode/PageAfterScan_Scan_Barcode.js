...
function PageAfterScan_Scan_Barcode() {
  ...
  useEffect(() => { if (isS8Open) setRingBump((b) => b + 1); }, [isS8Open]);
  ...
  useEffect(() => {
    ...
    const ref = doc(db, "users", uid, "RecentlyEaten", currentItemId);
  ...
  return (
    <View style={{ height: height(100), backgroundColor: "#fff" }}>
      <Animated.ScrollView
        contentContainerStyle={{ paddingTop: HEADER_MAX_HEIGHT - 32, paddingBottom: height(20) }}
      ...
      >
        ...
        <View style={{ height: height(45) }} pointerEvents="box-none">
          ...
          {/* dots */}
          <View style={{ flexDirection: "row", alignSelf: "center", marginTop: height(1) }}>
...
const styles = StyleSheet.create({
  ...
  totalsHeader: { marginTop: height(10), fontSize: size(18), fontWeight: "bold", marginLeft: width(5) },
...
export default PageAfterScan_Scan_Barcode;
