...
function PageAfterScan_Scan_Barcode() {
  ...
  const { present, isS3Open, setIsS3Open, setIsS6Open, isS6Open, isS8Open, isS9Open } = useSheets();
  ...
  }, [isS3Open, currentItemId, setCurrentItem, refreshVer]);
...
const styles = StyleSheet.create({
  ...
  titleRow: { flexDirection: "row", marginTop: height(8), marginLeft: width(5) },
