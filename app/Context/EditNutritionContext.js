// Context/EditNutritionCOntext.js
import { createContext, useCallback, useContext, useMemo, useState } from "react";

const EditNutritionContext = createContext();

export function EditNutritionProvider({ children }) {
  // ---------- Birthday ----------
  const now = new Date();
...
export function useEditNutrition() {
  return useContext(EditNutritionContext);
}
