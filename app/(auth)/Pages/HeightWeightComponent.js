...
const HeightWeightComponent = memo(function HeightWeightComponent() {
  ...
  return (
    <View style={{ width: "100%", backgroundColor: "#fff" }}>
      <Text style={{ fontSize: 28, marginTop: height(2), marginLeft: width(1), fontWeight: "700" }}>
        Height & weight
      </Text>
...
export default function HealthSetupScreen({ goalId, goalIds }) {
  ...
  const subtitle = useMemo(() => {
    ...
    if (showDiabetes) return "Per-meal carb targets and blood sugar reminders.";
    if (showKidney)   return "Daily sodium caps, hydration minimums, and protein guidance.";
    if (showHeart)    return "Sodium caps, BP tracking, and saturated-fat guidance.";
    if (showCoffee)   return "Set a daily caffeine limit and optional reminders.";
    if (showSmoking)  return "Set a daily cigarette target and check-in reminders.";
